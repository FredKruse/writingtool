...
import org.languagetool.openoffice.gui.Configuration;
import org.languagetool.openoffice.gui.ConfigurationDialog;
            ...
            try {
              ...
              for (Rule rule : lt.getAllRules()) {
                if (error.aRuleIdentifier.equals(rule.getId())) {
                  ...
                  String msg = org.languagetool.openoffice.gui.Tools.shortenComment(tmp);
                  String sUrl = null;
