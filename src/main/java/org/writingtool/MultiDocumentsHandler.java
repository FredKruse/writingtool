...
import org.writingtool.SingleDocument.RuleDesc;
import org.writingtool.SpellAndGrammarCheckDialog.LtCheckDialog;
import org.writingtool.aisupport.AiCheckQueue;
...
//          resetCheck();
  ...
  public static String getServiceDisplayName(Locale locale) {
    return OfficeTools.WT_DISPLAY_SERVICE_NAME;
  }
