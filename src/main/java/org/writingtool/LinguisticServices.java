...
//      }
      ...
      if (!activate) {
        for (String serviceName : serviceNames) {
          if(!OfficeTools.WT_SPELL_SERVICE_NAME.equals(serviceName)) {
        ...
        if (add) {
          serviceList.add(OfficeTools.WT_SPELL_SERVICE_NAME);
        }
      }
...
*/
    ...
    MessageHandler.printToLogFile("LT spell service (" + OfficeTools.WT_SPELL_SERVICE_NAME + ") " + (!activate ? "deactivated" : "activated"));
    return true;
  }
